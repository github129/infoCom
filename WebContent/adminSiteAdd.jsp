...
<link rel="stylesheet" href="css/adminSiteAdd.css">
...
<tr><th>サイトID</th><th>サイト名</th><th>登録パス</th></tr>
<s:iterator value="list">

<tr><td><s:property value="siteId"/></td><td><s:property value="siteName"/></td><td><s:property value="pass"/></td></tr>
					...
					<form action="SiteInsertAction">
						<table>
							...
							<tr>
								<th>取得パス</th>
								<td><input type="number" name="pass" min="0"></td>
							</tr>
							<tr><td></td><td><button type="submit">登録</button></td></tr>
