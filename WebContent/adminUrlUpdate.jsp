...
<form action="AdminUrlUpdateAction">
<table>
<tr><th>UrlId</th><th>サイトID</th><th>商品ID</th><th>パス</th><th>URL</th></tr>
<tr>
<td><input  readonly="readonly" type="number" min="1" max="999999" name="urlId" required="required" value="${urlId}"></td>
<td><input type="number" min="1" max="999999" name="siteId" required="required" value="${siteId}"></td>
<td><input type="number" min="1" max="999999" name="itemId" required="required" value="${itemId}"></td>
<td><input  readonly="readonly" type="number" min="0" max="999999" name="pass" required="required" value="${pass}"></td>
<td><input type="text" name="url" value="${url}"  required="required"></td>
