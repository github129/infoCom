...
<body>
	...
	<p>ここではサイト情報を取得するためのパスが確認できます。</p>
	<p>URLとサイトを選択してパスを確認して下さい。</p>

	<form action="">
	<span>サイト名<input type="text" name="siteName"></span>
	<span>商品名<input type="text" name="itemName"></span>
	<span>URL<input type="text" name="url"></span>
	<button type="submit">テスト開始</button>
	</form>

<s:property value="yenList"/>
